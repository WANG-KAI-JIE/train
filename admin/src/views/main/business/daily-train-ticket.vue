<template>
  <p>
    <a-space>
      ...
      <station-select-view v-model:value="params.start" placeholder="请选择出发站" width="200px"/>
      <station-select-view v-model:value="params.end" placeholder="请选择到达站" width="200px"/>
